  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBarWidget(title: tr('learn.title')),
      ),
      body: ListView(
        ...
        children: [
          GestureDetector(
            ...
            child: LearnWidget(
              icon: AppIcons.bookA,
              title: tr('learn.reading'),
              description: tr('learn.lesson_description'),
            ),
          ),
          GestureDetector(
            onTap: () {
